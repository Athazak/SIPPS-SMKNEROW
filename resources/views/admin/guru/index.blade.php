<x-app-layout>
    ...
    <div class="py-1" x-data="{ openImport: false, openReset: false,
        resetName: '',
        resetAction: '', }">
        <div class="max-w-7xl mx-auto px-3 lg:px-4">
            ...
            <div class="rounded-2xl shadow px-4 py-4 mb-3 flex items-center bg-white text-white">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Halaman ini digunakan untuk mengimport data dan mereset password guru.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white shadow rounded-xl px-4 py-3 mb-3 border border-gray-100">
                    ...
                    <table class="min-w-full text-sm text-left">
                        <thead>
                            <tr class="bg-[#F4F5FF] dark:bg-gray-700 text-[#2A166F] dark:text-gray-200 border-b">
                                ...
                                <th class="px-4 py-3 font-semibold">NUPTK</th>
                                <th class="px-4 py-3 font-semibold">NIP</th>
                                <th class="px-4 py-3 font-semibold">JK</th>
                                <th class="px-4 py-3 font-semibold">Status Kepegawaian</th>
                            ...
                            @forelse ($guru as $index => $item)
                                <tr class="border-b hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <button
                                            @click="openReset = true; resetName = '{{ $item->user->nama }}'; resetAction = '{{ route('admin.guru.reset-password', $item->user->id) }}';"
                ...
                <div class="mt-4">
                    {{ $guru->appends(request()->query())->links('vendor.pagination.simple-modern') }}
                </div>
            </div>

            <x-modal title="Import Data Guru" show="openImport">
