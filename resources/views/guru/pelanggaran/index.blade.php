<x-app-layout>
    ...
    <div class="py-1" x-data="{ openTambah: false }">
        ...
        <div class="max-w-7xl mx-auto px-3 lg:px-4" x-data="{ selectedRombel: '' }">
            ...
            <div class="rounded-2xl shadow px-4 py-4 mb-3 flex items-center bg-white text-white">
                <div class="flex flex-col">
                    <h1 class="text-2xl font-bold text-[#2A166F]">Pencatatan Pelanggaran Siswa</h1>
                    <p class="text-gray-600 mt-1 text-sm">
                        Halaman ini digunakan untuk mencatat pelanggaran siswa per kelas.
                    </p>
                </div>
            </div>
                        ...
                        <tbody>
                            @forelse ($catatan as $item)
                                <tr x-show="!selectedRombel || selectedRombel === '{{ $item->siswa->rombel->nama_rombel }}'"
                                    ...
                                    <td class="px-4 py-2 font-medium">{{ $item->pelanggaran->jenis_pelanggaran }}</td>
                                    <td class="px-4 py-2 text-gray-700">{{ $item->pelanggaran->bentuk }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="py-5 text-center text-gray-500">
                                        Belum ada data catatan pelanggaran.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        {{-- ===== MODAL TAMBAH ===== --}}
        <x-modal title="Catat Pelanggaran Siswa" show="openTambah">
